...
<section class="related">
    ...
    <div class="container">
        <div class="related_slider owl-carousel">
            ...
            ?>
                        <a href="<?php echo $product_link; ?>" class="related_slider-item" title="product">
                            <div class="related_slider-item-top flex">
                                <?php if ($product->is_on_sale()) : ?>
                                    <div class="related_slider-item-sale">
                            ...
                            <div class="related_slider-item-bottom text_c">
                                <h3 class="related_slider-item-title"><?php echo $title; ?></h3>
                                <div class="related_slider-item-price">
